...
My consulting activity stems from direct experience with companies in various sectors — particularly **banking, manufacturing, and telecommunications** — where I have had the opportunity to guide teams and IT departments in adopting new technologies and complying with regulations. I do not offer "packaged" solutions, but concrete pathways that combine analysis, rapid prototyping, continuous testing, and operational support up to production deployment. The goal is always the same: **to deliver measurable value quickly**, reducing risks and complexity.

## Microsoft 365 & SharePoint Online

Digital transformation often goes through the digital workplace. I help companies **design and implement corporate intranets** that are not just simple bulletin boards, but daily work tools.
...
* Support in **vendor selection** and technological governance.
