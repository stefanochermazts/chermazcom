...
<TwoCol src="/images/stefano chermaz.jpg" alt="Stefano Chermaz" width={600} height={800} caption="Stefano Chermaz" columns="34% 66%">
  <span slot="badge" class="inline-flex items-center gap-2 rounded-xl bg-white/90 dark:bg-zinc-900/90 ring-1 ring-black/10 dark:ring-white/10 px-3 py-2 shadow-sm text-sm font-medium">
    <span class="i-[ph--check-circle]" aria-hidden="true">✔</span>
