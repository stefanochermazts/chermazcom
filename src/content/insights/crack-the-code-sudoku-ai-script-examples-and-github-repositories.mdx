...
date: 2024-06-06
status: publish
description: "Sudoku AI: esempi di script, algoritmi (backtracking, single cells) e repository GitHub utili per imparare e contribuire."
...
<TwoCol src="" alt="Esempi di codice AI per risolvere Sudoku" width={1200} height={800} caption="Script AI per Sudoku: algoritmi ed esempi">
