...
description: >-
  ...
  from CV parsing to creating the HR portal on SharePoint.
excerpt: In this first chapter of the *HR 4.0* series, we will see how **AI development** and **Microsoft 365** can be integrated to transform candidate management and onboarding, making the process fast, standardized, and scalable.
categories:
  - ai-development
tags:
  - sharepoint
