...
date: 2024-04-29
status: publish
description: "WP Rocket su WordPress: setup consigliato, cache, ottimizzazione CSS/JS, lazyload e CDN. Strumenti per misurare performance."
...
<TwoCol src="" alt="Impostazioni di WP Rocket in WordPress" width={1200} height={800} caption="WP Rocket: cache, ottimizzazione e CDN">
...
- Installazione: in Bacheca vai su Plugin > Aggiungi nuovo, cerca "WP Rocket" e installa/attiva.
- Configurazione: imposta cache, minify/concatenate CSS e JS con prudenza, lazyload immagini.
- Pulizia cache: usa la funzione "Pulisci cache" dopo aggiornamenti di tema/plugin.
