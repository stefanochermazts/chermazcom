...
status: publish
description: >-
  How to create a chatbot in Dialogflow: agent, intent, entities, testing, and integrations. Benefits, setup, and
  practical tips.
excerpt: 'Dialogflow: create a chatbot with agent, intent, entities, testing, and integrations.'
categories:
  - chatbot
tags:
  - chatbot
